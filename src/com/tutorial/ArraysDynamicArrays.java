...
public class ArraysDynamicArrays {
    ...
    public void executeArraysDynamicArrays() {
        ...
        System.out.println("AS1 - GoodPair :" + outputAS1);

        //AS2> FizzBuzz
        System.out.print("AS2 - FizzBuzz :");
        ...
        int outputAS3 = timeToEquality(inputAS3);
        System.out.println("AS3 - TimeToEquality :" + outputAS3);
        ...
        System.out.print("AS5 - Leaders in an array :");
        outputAS5.forEach(e -> {
            System.out.print(e + " ");
        });
        System.out.println("");

        //AS6 > Max Sum Contiguous Subarray
        ArrayList<Integer> inputAS6 = new ArrayList<Integer>(Arrays.asList(-2, 1, -3, 4, -1, 2, 1, -5, 4));
        Integer outputAS6 = maxSumContiguousSubarray(inputAS6);
        System.out.println("AS6 - Max Sum Contiguous Subarray :" + outputAS6);

        //AS7 > Max Sum Contiguous Subarray
        ...
        System.out.print("AS7 - Multiple left rotations of the array :");
        ...
        System.out.println("AS8 - Noble Integer :" + outputAS8);
        ...
        System.out.print("AS9 - Reverse the array :");
        outputAS9.forEach(e -> {
            System.out.print(e + " ");
        });
        System.out.println("");
...
//        });
    ...
    /**
     * AS1 > Good Pair. Given an array A and a integer B. A pair(i,j) in the array is a good pair if i!=j and (A[i]+A[j]==B).
    ...
    /**
     * AS2 > FizzBuzz. Given a positive integer A, return an array of strings with all the integers from 1 to N.
    ...
    /**
     * AS3 > Time to equality. Given an integer array A of size N. In one second you can increase the value of one element by 1.
    ...
    /**
     * AS4 > Rotation Game - You are given an integer array A and an integer B.
    ...
    /**
     * AS5 > Leaders in an array. Given an integer array A containing N distinct integers, you have to find all the leaders in the array A.
    ...
    private int maxSumContiguousSubarray(ArrayList<Integer> A) {
        ...
        // Approach 1 => Brute Force 2 => Time Limit Exceeded => O(N^3)
        //        int maxSum = Integer.MIN_VALUE;
        //        for (int i = 0; i < A.size(); i++) {
        //            for (int j = 0; j <= i; j++) {
        //                int sum = 0;
        ...
        for (int i = 0; i < A.size(); i++) {
            rollingSum = rollingSum + A.get(i);
            readIndex.add(i);
            int sum = 0;
            for (int j = 0; j <= i; j++) {
                if (!readIndex.contains(j)) {

                }
                sum = sum + rollingSum;

//                if (i != j) {
//                    sum = rollingSum + A.get(j);
//                }
...
//        }
    ...
    /**
     * AS9 > Reverse the Array - You are required to return another array which is the reversed form of input array.
    ...
    /**
     * AS10 > Subarray with least average - Given an array of size N, Find the subarray with least average of size k.
